...
namespace APIVerve
{
    public class WordsExtractorAPIClient
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/wordsextractor";
        ...
        public WordsExtractorAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public WordsExtractorAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, wordsextractorQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(wordsextractorQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(wordsextractorQueryOptions options)
        {
